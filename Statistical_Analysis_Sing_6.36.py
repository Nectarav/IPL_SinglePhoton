...
xData = np.genfromtxt('6.36_Data.csv', usecols=XCOLUMN, skip_header=NUMBEROFHEADERS, delimiter=',')
yData = np.genfromtxt('6.36_Data.csv', usecols=YCOLUMN, skip_header=NUMBEROFHEADERS, delimiter=',')
...
plt.plot(theta, y, color = 'blue', label=FITLABEL, linestyle = 'dotted')
...
PLOTTITLE = "Voltage as a Function of Micrometer Position for a Single Slit Experiment (at 6.36mm)"
plt.title(PLOTTITLE)

...
xData = np.genfromtxt('6.75_Data.csv', usecols=XCOLUMN, skip_header=NUMBEROFHEADERS, delimiter=',')
yData = np.genfromtxt('6.75_Data.csv', usecols=YCOLUMN, skip_header=NUMBEROFHEADERS, delimiter=',')
